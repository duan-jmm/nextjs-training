        ...
        <div className={"w-full flex justify-center"}>
          <div className="px-6 lg:px-10 bg-white dark:bg-scheme-dark-primary  shadow-lg rounded-xl w-full max-w-lg py-10 space-y-4 lg:space-y-8">
            <div className="w-full">
              <h1 className={"text-gray-600 font-sf-bold dark:text-gray-200 text-2xl font-semibold text-center"}>REGISTER</h1>
            </div>
                ...
                <div className={"flex items-center justify-center my-4"}>
                  <p className={"font-semibold text-gray-500 text-sm lg:text-base"}>
                    ...
                    <Link href={"/auth/login"}>
                      <span className={"underline text-red-500 cursor-pointer text-sm lg:text-base"}>Masuk Sekarang</span>
                    </Link>
                  </p>
                </div>
              </div>
